...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "hangout cafe surat",
    "vesu cafe",
    "affordable cafe surat",
    "cafe near sd jain school",
    "friends hangout cafe",
    "couples cafe vesu",
    "private seating cafe"
  ],
  openGraph: {
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    "image": "https://thecafe4you.com/hero.jpg", // Placeholder - replace with actual image
    "address": {
      "@type": "PostalAddress",
    ...
    "url": "https://thecafe4you.com", // Replace with actual URL
    ...
    "servesCuisine": "Cafe, Fast Food, Beverages, Desserts",
    "priceRange": "₹",
    "starRating": {
      "@type": "Rating",
