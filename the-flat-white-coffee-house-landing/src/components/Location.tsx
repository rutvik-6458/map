            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                >
                    <div className="lg:w-1/2 p-12 lg:p-20 text-white flex flex-col justify-center">
                        <div className="mb-12">
                            <div className="inline-flex items-center gap-2 bg-amber-700/20 text-amber-400 px-4 py-2 rounded-full text-sm font-bold tracking-widest uppercase mb-6">
                                <Navigation size={14} />
                                <span>Find Us</span>
                            </div>
                        ...
                        <div className="space-y-12">
                            <div className="flex gap-8 group">
                                <div className="w-16 h-16 bg-amber-700 rounded-3xl flex items-center justify-center flex-shrink-0 transition-transform group-hover:rotate-6">
                        ...
                        <div className="mt-20 flex flex-col sm:flex-row gap-4">
                            ...
                            >
                                <button className="bg-white text-gray-950 px-12 py-6 rounded-3xl font-black text-xl flex items-center gap-4 hover:bg-amber-700 hover:text-white transition-all active:scale-95 group w-full sm:w-auto justify-center">
                                    Get Directions
