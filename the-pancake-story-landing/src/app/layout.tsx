...
const locality = addressParts[3]?.trim() || "Vesu";
...
export const metadata: Metadata = {
  ...
  keywords: `pancakes, dessert cafe Vesu Surat, chocolate desserts, waffles, milkshakes, late night desserts, ${cafeData.brand.city_area}, pancake shop, dessert restaurant, sweet treats`,
  openGraph: {
