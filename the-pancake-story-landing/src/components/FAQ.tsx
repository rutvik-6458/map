                    ...
                    {faqs.map((faq, idx) => (
                        <div
                            ...
                            className={cn(
                                ...
                                openIdx === idx ? "border-orange-200 shadow-xl shadow-orange-100/50" : "border-gray-100"
                            )}
                        >
                            <button
                            ...
                            >
                                <span className={cn(
                                    ...
                                    openIdx === idx ? "text-orange-700" : "text-gray-800 group-hover:text-orange-700"
                                )}>
                                    {faq.q}
                                </span>
                                <div className={cn(
                                    "p-2 rounded-xl transition-all",
                                    openIdx === idx ? "bg-orange-600 text-white rotate-180" : "bg-gray-100 text-gray-500"
                                )}>
                                    <ChevronDown size={20} />
                                </div>
                            </button>
                                ...
                                {openIdx === idx && (
                                    ...
                                    >
                                        <div className="px-8 pb-8 text-gray-600 text-lg leading-relaxed font-medium">
                                            <div className="p-6 bg-orange-50/50 rounded-2xl border border-orange-50">
                                                {faq.a}
                                            </div>
                                        </div>
                                    </motion.div>
