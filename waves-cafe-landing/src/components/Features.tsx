...
import { Star, Coffee, Heart, UtensilsCrossed, Users, Truck } from "lucide-react";
...
export default function Features() {
    const features = [
        {
            icon: Star,
            title: "4.2-Star Rated Cafe",
            description: "Highly rated with excellent reviews for food quality and service.",
            color: "amber"
        },
        {
            icon: Coffee,
            title: "Coffee and Beverages",
            description: "Enjoy quality coffee and refreshing beverages in a calm setting.",
            color: "amber"
        },
        {
            icon: UtensilsCrossed,
            title: "Good Food Quality",
            description: "Consistently good food that customers love and recommend.",
            color: "green"
        },
        {
            icon: Heart,
            title: "Calm Atmosphere",
            description: "Pleasant and comfortable ambience perfect for relaxed visits.",
            color: "red"
        },
        {
            icon: Users,
            title: "Friendly Service",
            description: "Attentive and friendly staff ensuring a great experience.",
            color: "blue"
        },
        {
            icon: Truck,
            title: "Multiple Options",
            description: "Dine-in, takeaway, and delivery options for your convenience.",
            color: "purple"
        },
    ];
