...
import { CheckCircle2, Users, Coffee, Zap, Star, MapPin, UtensilsCrossed } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl md:text-5xl font-bold font-playfair mb-8 leading-tight">
              Everything You Love About <span className="text-primary">A Great Coffee Club</span>
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {businessData.content_blocks.features_bullets.map((feature, index) => {
                const Icon = ICON_MAP[Object.keys(ICON_MAP).find(key => feature.toLowerCase().includes(key.toLowerCase())) || ""] || Zap;
                return (
          ...
          <div className="relative group">
            ...
            <img
              ...
              alt="Odd Three Coffee Club Interior"
