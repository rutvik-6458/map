      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            A glimpse into the {businessData.brand.business_name} experience
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-muted-foreground">
            📸 Replace these placeholder images with actual photos from your cafe. Recommended shots: Cafe interior and seating, Barista preparing coffee, Cold brew and specialty coffee drinks, Customers working or relaxing, Exterior and VIP Road view
          </p>
        </div>
      </div>
    </section>
