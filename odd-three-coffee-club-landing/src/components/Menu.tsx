    ...
    <section id="menu" className="py-24 bg-secondary/20">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold font-playfair mb-6">Our Specialty Coffee & Menu</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            From refreshing Cold Brew Coffee to unique Barrel Tonic, we serve specialty coffee that makes you come back.
          </p>
        </div>
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <p className="text-sm text-muted-foreground mb-6 leading-relaxed">
                    Crafted with passion and served with care. A must-try at {businessData.brand.business_name}.
                  </p>
        ...
        <div className="mt-20 text-center">
          <p className="text-muted-foreground mb-8">Perfect for all your coffee needs and work sessions.</p>
