      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-base sm:text-lg text-stone-600 px-4">
            We&apos;re located on VIP Road in {cafeData.brand.city_area}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          <div className="space-y-4 sm:space-y-6">
            <div className="bg-white p-4 sm:p-6 rounded-xl shadow-md border border-stone-100">
              <div className="flex items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-semibold text-sm sm:text-base text-amber-900 mb-1 sm:mb-2">Address</h3>
                  <p className="text-xs sm:text-sm text-stone-700 break-words">{cafeData.contact.address}</p>
                </div>
              </div>
            </div>
            ...
            {hasPhone && (
              <div className="bg-white p-4 sm:p-6 rounded-xl shadow-md border border-stone-100">
                <div className="flex items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-sm sm:text-base text-amber-900 mb-1 sm:mb-2">Phone</h3>
                    <a
                      href={`tel:${phone}`}
                      className="text-xs sm:text-sm text-amber-700 hover:text-amber-800 font-medium break-all"
                    >
            ...
            {cafeData.contact.hours && (
              <div className="bg-white p-4 sm:p-6 rounded-xl shadow-md border border-stone-100">
                <div className="flex items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-sm sm:text-base text-amber-900 mb-1 sm:mb-2">Hours</h3>
                    <p className="text-xs sm:text-sm text-stone-700">{cafeData.contact.hours}</p>
                  </div>
                </div>
              </div>
            )}
            ...
            {hasGoogleMaps ? (
              <Button
                size="lg"
                className="w-full bg-gradient-to-r from-amber-800 to-amber-700 hover:from-amber-900 hover:to-amber-800 text-white text-sm sm:text-base py-5 sm:py-6"
