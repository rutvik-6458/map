...
export default function Location() {
  const address = "CAFETRIO, 15, Vesu, Surat, Gujarat 395007 (Located in Digital Asset Academy)";
  const hours = "Opens at 11 am";
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Find us in Vesu, Surat for a pocket-friendly cafe experience
          </p>
        </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              {phoneNumber && (
                <a
                  ...
                  className="flex-1 bg-amber-600 hover:bg-amber-700 text-white px-6 py-4 rounded-xl font-bold text-center transition-all transform hover:scale-105 active:scale-95 shadow-lg shadow-amber-600/20 flex items-center justify-center gap-2"
                >
                  <Phone size={20} />
                  Call Now
                </a>
