...
export default function Trust() {
    const reviews = [
        {
            text: "Bubble teas are my personal favourite and I mostly prefer choosing this place.",
            author: "Verified Customer",
            initial: "B"
        },
        {
            text: "Best waffle and service was fast and taste was best.",
            author: "Happy Customer",
            initial: "W"
        },
        {
            text: "You can customise the flavours of bubble tea as well as waffle according to your preference.",
