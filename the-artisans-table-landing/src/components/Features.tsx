        ...
        <div className="mt-8 sm:mt-10 md:mt-12">
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
            {cafeData.positioning.best_for.map((item, index) => (
              <span
                key={index}
                className="px-3 sm:px-4 md:px-5 py-2 sm:py-2.5 md:py-3 bg-white border-2 border-amber-200 text-amber-800 rounded-full text-xs sm:text-sm font-medium shadow-sm"
              >
                {item}
              </span>
            ))}
