        ...
        <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
            <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 lg:py-16">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 mb-8 sm:mb-12">
                    {/* Brand */}
                    <div>
                        <h3 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-amber-400 to-orange-400 bg-clip-text text-transparent mb-3 sm:mb-4">
                            Apetito
                        </h3>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 sm:space-y-4">
                            <li className="flex items-start gap-2 sm:gap-3">
                                <Phone className="w-4 h-4 sm:w-5 sm:h-5 text-amber-400 flex-shrink-0 mt-1" />
                                <a
                                    href="tel:+917802001555"
                                    className="text-sm sm:text-base text-gray-400 hover:text-amber-400 transition-colors break-all"
                                >
                                    078020 01555
                                </a>
                            </li>
                            <li className="flex items-start gap-2 sm:gap-3">
                                <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-amber-400 flex-shrink-0 mt-1" />
                                <span className="text-sm sm:text-base text-gray-400 break-words">
                    ...
                    {/* Hours */}
                    <div>
                        <h4 className="text-base sm:text-lg font-bold mb-3 sm:mb-4">Opening Hours</h4>
                        <div className="space-y-2 sm:space-y-3">
                            <div className="flex justify-between items-center text-sm sm:text-base text-gray-400">
                                <span>Monday - Sunday</span>
                            </div>
                            <div className="text-sm sm:text-base text-amber-400 font-semibold">
                                Open Daily
                            </div>
