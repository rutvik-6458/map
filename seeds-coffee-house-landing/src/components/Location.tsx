            ...
            <div className="flex flex-col sm:flex-row gap-4">
              {phoneNumber && (
                <a
                  ...
                  className="flex-1 bg-amber-800 hover:bg-amber-900 text-white px-6 py-4 rounded-xl font-bold text-center transition-all transform hover:scale-105 active:scale-95 shadow-lg shadow-amber-800/20 flex items-center justify-center gap-2"
                >
                  <Phone size={20} />
                  Call Now
                </a>
