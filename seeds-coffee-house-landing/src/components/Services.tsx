        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {signatureItems.map((item, index) => {
            ...
            return (
              ...
              >
                <div className="w-14 h-14 bg-amber-800 rounded-xl flex items-center justify-center mb-4 shadow-lg shadow-amber-200">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100">
          ...
          <div className="mt-8 pt-8 border-t border-gray-200 flex flex-wrap items-center justify-center gap-6">
            ...
            <div className="flex items-center gap-2 text-gray-700">
              ...
              <span className="font-semibold">Dine-in • Kerbside Pickup • Delivery</span>
            </div>
          </div>
        </div>
      </div>
