...
export function FAQ() {
  ...
  return (
    <section id="faq" className="py-16 sm:py-20 md:py-24 bg-secondary/10 w-full overflow-x-hidden">
      <div className="container mx-auto px-4 sm:px-6 max-w-4xl w-full">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-sm sm:text-base text-muted-foreground px-4">Everything you need to know about visiting {businessData.brand.business_name}.</p>
        </div>
