...
export const metadata: Metadata = {
  ...
  keywords: ["cheezylicious cafe", "cafe in vesu", "best cafe surat", "cheese cafe", "bunny chow", "cheesy snacks", "vesu cafe"],
  openGraph: {
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    "image": "https://cheezyliciouscafe.com/hero.jpg", // Placeholder - replace with actual image
    "address": {
      "@type": "PostalAddress",
    ...
    "url": "https://cheezyliciouscafe.com", // Replace with actual URL
    ...
    "servesCuisine": "Cafe, Snacks, Beverages, Cheese Dishes",
    "priceRange": "$$",
    "starRating": {
      "@type": "Rating",
