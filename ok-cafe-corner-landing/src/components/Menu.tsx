      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            From delicious coffee and cafe snacks to comfort beverages, we serve flavors that make you come back.
          </p>
        </div>
            ...
            return (
              ...
              >
                <div className="h-64 overflow-hidden relative">
                  <img
                    src={typeof menuImage === 'string' ? menuImage : menuImage.src}
                    alt={item}
