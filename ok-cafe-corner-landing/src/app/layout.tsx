...
export const metadata: Metadata = {
  ...
  keywords: [
    "ok cafe corner",
    "cafe in vesu",
    "budget friendly cafe surat",
    "coffee shop vesu",
    "hangout cafe surat",
    "vesu cafe",
    "affordable cafe surat",
    "cafe near nandanvan vesu"
  ],
  openGraph: {
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    "image": "https://okcafecorner.com/hero.jpg", // Placeholder - replace with actual image
    "address": {
      "@type": "PostalAddress",
    ...
    "url": "https://okcafecorner.com", // Replace with actual URL
    ...
    "servesCuisine": "Cafe, Coffee, Cafe Snacks, Comfort Beverages",
    "priceRange": "₹",
    "starRating": {
      "@type": "Rating",
