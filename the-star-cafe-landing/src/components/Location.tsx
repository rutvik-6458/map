                ...
                >
                    <div className="lg:w-1/2 p-12 lg:p-20 text-white flex flex-col justify-center">
                        <div className="mb-12">
                            ...
                            <h2 className="text-4xl md:text-5xl font-extrabold mb-8 tracking-tight">Visit The Star Cafe</h2>
                        ...
                        <div className="space-y-12">
                            <div className="flex gap-8 group">
                                <div className="w-16 h-16 bg-amber-600 rounded-3xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-amber-500/20 transition-transform group-hover:rotate-6">
                        ...
                        <div className="mt-20 flex flex-col sm:flex-row gap-4">
                            ...
                            >
                                <button className="bg-white text-gray-950 px-12 py-6 rounded-3xl font-black text-xl flex items-center gap-4 hover:bg-amber-600 hover:text-white transition-all shadow-2xl active:scale-95 group w-full sm:w-auto justify-center">
                                    Get Directions
