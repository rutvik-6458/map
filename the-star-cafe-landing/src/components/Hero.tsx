        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
            <div className="absolute inset-0 z-0">
                <Image
                    ...
                    quality={90}
                />
                <div className="absolute inset-0 from-amber-900/60 via-amber-800/50 to-amber-700/60"></div>
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center">
                ...
                >
                    ...
                    <div className="mt-12 sm:mt-20 flex flex-wrap justify-center gap-4 sm:gap-10 items-center opacity-80 px-4">
                        ...
                        <div className="flex items-center gap-2 text-white/70">
                            ...
                            <span className="font-bold text-xs sm:text-sm uppercase tracking-widest">Small Gatherings</span>
                        </div>
                        <div className="flex items-center gap-2 text-white/70">
                            <div className="w-2 h-2 rounded-full bg-blue-400"></div>
                            <span className="font-bold text-xs sm:text-sm uppercase tracking-widest">Student Friendly</span>
                        </div>
                    </div>
                </motion.div>
            </div>
