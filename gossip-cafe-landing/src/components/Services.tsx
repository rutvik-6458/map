                    ...
                    {menuItems.map((item, idx) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-xl shadow-gray-200/40 flex flex-col group hover:shadow-2xl hover:shadow-purple-100/50 transition-all duration-500 hover:-translate-y-2"
                            >
                                <div className="mb-6 p-4 bg-purple-50 w-fit rounded-2xl group-hover:bg-purple-600 group-hover:text-white transition-colors duration-500">
                                    <Icon size={40} />
                                </div>
                                <div className="mb-4">
                ...
                >
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        {cafeData.positioning.best_for.map((tag, idx) => (
                            <span
                                key={idx}
                                className="px-6 py-3 bg-purple-50 text-purple-700 rounded-full font-bold text-sm border border-purple-200"
                            >
                                {tag}
                            </span>
                        ))}
