            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                >
                    <div className="lg:w-1/2 p-12 lg:p-20 text-white flex flex-col justify-center">
                        <div className="mb-12">
                            <div className="inline-flex items-center gap-2 bg-purple-600/20 text-purple-400 px-4 py-2 rounded-full text-sm font-bold tracking-widest uppercase mb-6">
                                <Navigation size={14} />
                                <span>Find Us</span>
                            </div>
                        ...
                        <div className="space-y-12">
                            <div className="flex gap-8 group">
                                <div className="w-16 h-16 bg-purple-600 rounded-3xl flex items-center justify-center flex-shrink-0 transition-transform group-hover:rotate-6">
                                    <MapPin size={30} className="text-white" />
                                </div>
                                <div>
                                    <p className="text-purple-500 font-black uppercase tracking-widest text-[10px] mb-2">Our Address</p>
                            ...
                            {phoneNumber && (
                                <div className="flex gap-8 group">
                                    ...
                                    <div>
                                        ...
                                        <a href={`tel:${phoneNumber}`} className="text-xl md:text-2xl font-bold leading-tight text-gray-100 hover:text-purple-400 transition-colors">
                                            {phoneNumber}
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div className="mt-20 flex flex-col sm:flex-row gap-4">
                            ...
                            >
                                <button className="bg-white text-gray-950 px-12 py-6 rounded-3xl font-black text-xl flex items-center gap-4 hover:bg-purple-600 hover:text-white transition-all active:scale-95 group w-full sm:w-auto justify-center">
                                    Get Directions
