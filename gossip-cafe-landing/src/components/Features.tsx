                    ...
                    {features.map((feature, idx) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-lg shadow-gray-100/50 flex flex-col group hover:shadow-2xl hover:shadow-purple-100/50 transition-all duration-500"
                            >
