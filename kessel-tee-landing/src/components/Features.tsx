...
export default function Features() {
    const features = cafeData.content_blocks.features_bullets.map((bullet, idx) => {
        ...
        if (bullet.toLowerCase().includes("review") || bullet.toLowerCase().includes("rating")) {
            icon = Star;
            color = "amber";
        } else if (bullet.toLowerCase().includes("tea") || bullet.toLowerCase().includes("chai")) {
            icon = Coffee;
            color = "amber";
        } else if (bullet.toLowerCase().includes("open") || bullet.toLowerCase().includes("late")) {
            icon = Clock;
            color = "orange";
        } else if (bullet.toLowerCase().includes("location") || bullet.toLowerCase().includes("prime")) {
            icon = MapPin;
            color = "blue";
