                ...
                <div className="text-center mb-12 sm:mb-16">
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center justify-center gap-3 sm:gap-4">
                            ...
                            <p className="text-gray-600 font-medium max-w-2xl mx-auto mt-3 sm:mt-4 text-sm sm:text-base px-4">
                    ...
                    {reviews.map((review, idx) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3 sm:gap-4 pt-4 sm:pt-6 border-t border-gray-50">
                                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center text-white font-bold shadow-lg shadow-amber-200 text-sm sm:text-base">
                                    {review.initial}
                                </div>
                                <div>
