            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {reviews.map((review, idx) => (
                        ...
                        >
                            <div className="mb-8 p-3 bg-amber-50 w-fit rounded-2xl group-hover:bg-amber-600 group-hover:text-white transition-colors duration-500">
                                <Quote size={24} />
                            </div>
                            ...
                            <div className="flex items-center gap-4 pt-6 border-t border-gray-50">
                                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center text-white font-bold shadow-lg shadow-amber-200">
                                    {review.initial}
                                </div>
                                <div>
