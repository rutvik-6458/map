        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center">
                ...
                >
                    ...
                    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-8xl font-black text-white leading-tight mb-6 sm:mb-8 tracking-tighter px-4">
                        {headline.includes("–") ? (
                            <>
                    ...
                    <div className="mt-12 sm:mt-16 md:mt-20 flex flex-wrap justify-center gap-6 sm:gap-8 md:gap-10 items-center opacity-80 px-4">
                        <div className="flex items-center gap-2 text-white/70">
                            <div className="w-2 h-2 rounded-full bg-amber-400"></div>
                            <span className="font-bold text-xs sm:text-sm uppercase tracking-widest">Wide Tea Variety</span>
                        </div>
                        <div className="flex items-center gap-2 text-white/70">
                            <div className="w-2 h-2 rounded-full bg-orange-400"></div>
                            <span className="font-bold text-xs sm:text-sm uppercase tracking-widest">Late Night Open</span>
                        </div>
                        <div className="flex items-center gap-2 text-white/70">
                            <div className="w-2 h-2 rounded-full bg-green-400"></div>
                            <span className="font-bold text-xs sm:text-sm uppercase tracking-widest">Tea & Snacks</span>
                        </div>
                    </div>
                </motion.div>
            </div>
