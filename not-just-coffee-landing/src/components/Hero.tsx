                ...
                >
                    ...
                    <div className="mt-20 flex flex-wrap justify-center gap-10 items-center opacity-80">
                        ...
                        <div className="flex items-center gap-2 text-white/70">
                            ...
                            <span className="font-bold text-sm uppercase tracking-widest">Great Desserts</span>
                        </div>
                        <div className="flex items-center gap-2 text-white/70">
                            <div className="w-2 h-2 rounded-full bg-blue-400"></div>
                            <span className="font-bold text-sm uppercase tracking-widest">VIP Road Location</span>
                        </div>
                    </div>
                </motion.div>
            </div>
