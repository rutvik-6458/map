...
export const metadata: Metadata = {
  ...
  keywords: `cafe Vesu Surat, cold coffee, affordable cafe, budget-friendly coffee, ${cafeData.brand.city_area}, ice creams, coffee beverages, Udhana Magdalla Road`,
  openGraph: {
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    "telephone": cafeData.contact.phone || undefined
  };
