        ...
        <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gray-50/30" id="faq">
            <div className="max-w-4xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-10 sm:mb-12 md:mb-16">
                    <div className="inline-flex p-3 bg-amber-100 text-amber-600 rounded-2xl mb-4 sm:mb-6">
                    ...
                    {faqs.map((faq, idx) => (
                        ...
                        >
                            <button
                                ...
                                className="w-full text-left p-5 sm:p-6 md:p-8 flex justify-between items-center gap-4 bg-white hover:bg-gray-50 transition-colors group"
                            >
                                <span className={cn(
