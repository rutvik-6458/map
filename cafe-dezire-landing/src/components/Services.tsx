...
export default function Services() {
    ...
    const menuItems = services.map((service, idx) => {
        ...
        if (service.toLowerCase().includes("cold coffee") || service.toLowerCase().includes("coffee")) {
            icon = Coffee;
            category = "Beverages";
        } else if (service.toLowerCase().includes("ice cream")) {
            icon = IceCream;
            category = "Desserts";
        } else {
                ...
                <div className="text-center mb-10 sm:mb-12 md:mb-16">
                    ...
                    >
                        ...
                        <p className="text-gray-600 text-base sm:text-lg font-medium max-w-2xl mx-auto px-4">
                            What we offer for your perfect coffee experience.
                        </p>
                    </motion.div>
                </div>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                    {menuItems.map((item, idx) => {
                        ...
                        return (
                            ...
                            >
                                <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-amber-50 text-amber-600 w-fit rounded-xl sm:rounded-2xl group-hover:bg-amber-600 group-hover:text-white transition-colors duration-500">
