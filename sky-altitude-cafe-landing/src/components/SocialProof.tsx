      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-8 sm:mb-12">
          <div className="flex items-center justify-center gap-2 mb-3 sm:mb-4">
            ...
            <span className="text-xl sm:text-2xl font-bold text-gray-900 ml-1 sm:ml-2">
              {rating}
            </span>
          </div>
        ...
        <div className="mt-8 sm:mt-12 text-center px-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3">
            {topReviewThemes.map((theme, index) => (
              <span
                key={index}
                className="px-3 sm:px-4 py-1.5 sm:py-2 bg-orange-50 text-orange-700 rounded-full text-xs sm:text-sm font-medium"
              >
                {theme}
              </span>
            ))}
