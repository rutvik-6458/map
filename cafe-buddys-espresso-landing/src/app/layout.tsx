...
export const metadata: Metadata = {
  title: `${businessName} - ${cafeData.brand.category} in ${cafeData.brand.city_area} | Espresso Coffee & Drive-Through`,
  description,
  keywords: [
    "cafe buddy's espresso",
    "espresso cafe vesu",
    "coffee shop surat",
    "drive-through coffee vesu",
    "espresso cafe surat",
    "cafe in vesu surat",
    "coffee delivery vesu",
    "dine-in cafe surat",
    "fresh coffee vesu",
    "local cafe surat",
  ],
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    servesCuisine: "Cafe, Espresso, Coffee, Beverages",
    aggregateRating: {
