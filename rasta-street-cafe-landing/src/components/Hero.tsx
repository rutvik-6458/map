      ...
      <div className="relative z-20 max-w-4xl mx-auto text-center">
        ...
        <div className="flex items-center justify-center gap-2 mb-10">
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-6 py-3 flex items-center gap-3 shadow-lg">
            ...
            <span className="text-gray-300">343 reviews</span>
          </div>
        </div>
        ...
        <div className="mt-12 flex flex-wrap items-center justify-center gap-4">
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-5 py-2 text-white text-sm shadow-md">
            📍 Vesu, Surat
          </div>
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-5 py-2 text-white text-sm shadow-md">
            🕐 Opens at 11:30 am
