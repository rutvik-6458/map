      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <button
            ...
            className="text-2xl font-bold bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent hover:scale-105 transition-transform"
          >
          ...
          <nav className="hidden md:flex items-center gap-8">
            {navItems.map((item) => (
              <button
                ...
                className="text-sm font-medium transition-all duration-200 hover:text-orange-600 text-gray-700"
              >
                {item.label}
              </button>
            ))}
            ...
            <nav className="flex flex-col gap-3">
              {navItems.map((item) => (
                <button
                  key={item.id}
                  onClick={() => scrollToSection(item.id)}
                  className="text-left px-4 py-2 rounded-lg transition-all text-gray-700 hover:bg-orange-100"
                >
                  {item.label}
                </button>
              ))}
