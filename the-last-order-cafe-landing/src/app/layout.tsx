...
export const metadata: Metadata = {
  title: `${businessName} - ${cafeData.brand.category} in ${cafeData.brand.city_area} | Late-Night Cafe & Comfort Food`,
  description,
  keywords: [
    "the last order cafe",
    "engine cafe",
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    servesCuisine: "Cafe, Comfort Food, Italian, Late-Night Dining",
    aggregateRating: {
