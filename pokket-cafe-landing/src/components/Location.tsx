...
export function Location() {
  ...
  // Generate Google Maps directions link (works without API key)
  ...
  // Using the search query format which works without API key
  const mapsEmbedUrl = hasGoogleMaps
    ? businessData.contact.google_maps_link
    : `https://www.google.com/maps?q=${encodeURIComponent(businessData.contact.address)}&output=embed`;
