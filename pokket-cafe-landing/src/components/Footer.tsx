...
export function Footer() {
  ...
  return (
    <footer className="bg-foreground text-white py-12 sm:py-16 md:py-20">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="pt-8 sm:pt-10 md:pt-12 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-6 text-xs sm:text-sm text-white/40">
