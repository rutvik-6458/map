      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
              ...
              {businessData.content_blocks.features_bullets.map((feature, index) => {
                ...
                return (
                  <div key={index} className="flex items-start gap-3 sm:gap-4">
                    ...
                    <span className="font-medium text-foreground py-1 sm:py-2 leading-tight text-sm sm:text-base">
                      {feature}
                    </span>
                  </div>
                );
          ...
          <div className="relative group mt-8 lg:mt-0">
            <div className="absolute -inset-2 sm:-inset-4 bg-primary/5 rounded-[1.5rem] sm:rounded-[2.5rem] rotate-2 group-hover:rotate-1 transition-transform" />
            <img
              src="https://images.unsplash.com/photo-1554118811-1e0d58224f24?q=80&w=2047&auto=format&fit=crop"
              alt="Cafe Interior"
              className="relative z-10 w-full h-[300px] sm:h-[400px] md:h-[500px] object-cover rounded-[1.5rem] sm:rounded-[2rem] shadow-2xl"
            />
