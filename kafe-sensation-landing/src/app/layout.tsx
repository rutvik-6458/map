...
export const metadata: Metadata = {
  ...
  keywords: ["kafe sensation", "cafe in vesu", "best cafe surat", "coffee shop vesu", "pizza pasta cafe", "frappe cafe", "vesu cafe", "hangout cafe surat"],
  openGraph: {
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    "image": "https://kafesensation.com/hero.jpg", // Placeholder - replace with actual image
    "address": {
      "@type": "PostalAddress",
    ...
    "url": "https://kafesensation.com", // Replace with actual URL
    "telephone": businessData.contact.phone,
    "openingHoursSpecification": {
      "@type": "OpeningHoursSpecification",
      "dayOfWeek": ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
      "opens": "11:00", // Update with actual opening time when available
      "closes": "23:00"
    },
    "servesCuisine": "Cafe, Pizza, Pasta, Frappe, Coffee, Mojitos",
    "priceRange": "₹₹",
    "starRating": {
      "@type": "Rating",
