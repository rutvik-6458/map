      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            From delicious pizzas and pastas to refreshing frappes and coffee, we serve flavors that make you come back.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {businessData.positioning.signature_items_or_services.map((item, index) => {
            // Map menu items to gallery images
            const menuImages = [gallery1, gallery2, gallery3];
            const menuImage = menuImages[index] || gallery1;
        ...
        <div className="mt-20 text-center">
          <p className="text-muted-foreground mb-8">Also serving fries, mojitos, and various comfort food items.</p>
