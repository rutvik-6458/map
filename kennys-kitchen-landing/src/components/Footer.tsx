...
export default function Footer() {
  const businessName = "Kenny's Kitchen";
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
          <div>
            <div className="flex items-center gap-2 mb-3 sm:mb-4">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-orange-600 rounded-xl flex items-center justify-center">
            ...
            <p className="text-sm sm:text-base text-gray-400 leading-relaxed">
              A well-loved cafe in Vesu, Surat, known for its relaxed ambience,
              friendly service and creative comfort food.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-400">
              <div className="flex items-start gap-2 sm:gap-3">
                <MapPin size={16} className="sm:w-4.5 sm:h-4.5 text-orange-500 mt-0.5 sm:mt-1 flex-shrink-0" />
                <span>{address}</span>
              </div>
              <div className="flex items-center gap-2 sm:gap-3">
                <Clock size={16} className="sm:w-4.5 sm:h-4.5 text-orange-500 flex-shrink-0" />
                <span>{hours}</span>
              </div>
              {phoneNumber && (
                <div className="flex items-center gap-2 sm:gap-3">
                  <Phone size={16} className="sm:w-4.5 sm:h-4.5 text-orange-500 flex-shrink-0" />
                  <a
