...
export const metadata: Metadata = {
  title: `${businessName} - ${cafeData.brand.category} in ${cafeData.brand.city_area} | Quiet Cafe with Privacy`,
  description,
  keywords: [
    "coffee castle cafe",
    "cafe in vesu surat",
    ...
    "quiet cafe surat",
    "coffee shop vesu",
    "cafe for couples surat",
    "safal square cafe",
    "cozy cafe vesu",
    "dine-in cafe surat",
    "takeaway coffee vesu",
  ],
  openGraph: {
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    servesCuisine: "Cafe, Coffee, Beverages",
    aggregateRating: {
