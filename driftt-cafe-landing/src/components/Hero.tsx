  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-amber-900 via-amber-800 to-amber-700">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-amber-600/20 text-amber-200 px-4 py-2 rounded-full border border-amber-400/30 mb-8 font-bold text-sm tracking-widest uppercase">
